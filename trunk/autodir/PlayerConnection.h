...
class VariantMapClient; // ../varnet
class GLWidgetSubview; // GLWidget.h
class GLDrawable;      // GLDrawable.h
class GLPlaylistItem;  // GLDrawable.h
class GLSceneGroup;    // GLSceneGroup.h
class GLScene;         // GLSceneGroup.h

class PlayerConnection; // This file
